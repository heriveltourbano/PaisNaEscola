...
export class MensagemComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Mensagem) {
        return item.id;
    }
    registerChangeInMensagems() {
        this.eventSubscriber = this.eventManager.subscribe('mensagemListModification', (response) => this.reset());
    }
