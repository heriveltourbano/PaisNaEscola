...
import br.com.unifae.software.eng.paisnaescola.repository.ClasseRepository;
...
public class ClasseResourceIntTest {
    ...
    private static final Integer DEFAULT_ANO_LETIVO = 2017;
    private static final Integer UPDATED_ANO_LETIVO = 2018;
    ...
    public void setup() {
        ...
        ClasseResource classeResource = new ClasseResource(classeRepository);
    ...
    public void createClasse() throws Exception {
        ...
        assertThat(testClasse.getAnoLetivo()).isEqualTo(DEFAULT_ANO_LETIVO);
    ...
    @Test
    @Transactional
    public void checkAnoLetivoIsRequired() throws Exception {
        int databaseSizeBeforeTest = classeRepository.findAll().size();
        // set the field null
        classe.setAnoLetivo(null);
    ...
    public void updateClasse() throws Exception {
        ...
        Classe testClasse = classeList.get(classeList.size() - 1);
        assertThat(testClasse.getAnoLetivo()).isEqualTo(UPDATED_ANO_LETIVO);
